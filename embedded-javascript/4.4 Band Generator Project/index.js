...
app.post("/submit", (req, res) => {
  ...
  let bandAdjective = adj[Math.floor(Math.random() * adj.length)];
  let bandNoun = noun[Math.floor(Math.random() * noun.length)];

  //2. Send the index.ejs as a response and add the adjective and noun to the res.render
  res.render("index.ejs", { adjective: bandAdjective, noun: bandNoun });
